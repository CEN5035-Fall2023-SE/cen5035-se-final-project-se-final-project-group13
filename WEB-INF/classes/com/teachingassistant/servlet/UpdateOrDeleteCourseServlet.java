 ...
 */
@WebServlet("/updateOrDeletecourse")
public class UpdateOrDeleteCourseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateOrDeleteCourseServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session != null) {
				...
				coursesList = courseDao.updateOrDeleteCourse(actionType, courseId, openPositions);
